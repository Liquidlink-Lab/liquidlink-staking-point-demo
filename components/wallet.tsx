          ...
          <div className="flex items-center gap-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-gray-900 border-gray-700 text-gray-200">
                ...
                <DropdownMenuItem className="hover:bg-gray-800 cursor-pointer" onClick={copyAddress}>
                ...
                <DropdownMenuSeparator className="bg-gray-700" />
                <DropdownMenuItem className="hover:bg-gray-800 cursor-pointer text-red-400" onClick={disconnectWallet}>
                  Disconnect
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
