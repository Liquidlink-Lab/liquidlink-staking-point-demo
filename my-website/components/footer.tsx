...
const openGithub = ()=>{
window.open("https://github.com/Liquidlink-Lab/liquidlink-staking-point-demo", "liquidlink-staking-point-demo");
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <p className="text-sm text-gray-500">
              © 2025 Liquid DeFi Protocol.liquidlink point system demo. All rights reserved.Design by
              liquidlink.
            </p>
          </div>
